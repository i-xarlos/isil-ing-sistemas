...
Venta directa de detergente concentrado para lavaplatos en sachets individuales. Producto diseñado desde cero para logística de e-commerce: peso < 750g, volumen mínimo, alta recurrencia.
...
| Dato | Fuente | Estado |
|---|---|---|
| Tarifas Chit Chats | chitchats.com | ✅ |
| Sendle Canadá | try.sendle.com | ⚠️ Halt enero 2026 |
| Precios competencia | Observación Walmart | ✅ |
| Self-storage St. Thomas | Make Space, Best Storage | ✅ |
| Regulación Canadá | Consumer Packaging Act | ✅ |
...
|---|---|---|---|
| 1 | Enviar RFQ a 3+ fabricantes | Alta | Pendiente |
| 2 | Cotizar envío real desde St. Thomas | Alta | Pendiente |
| 3 | Pedir muestras y probar | Alta | Pendiente |
| 4 | Investigar 3PLs en London/GTA | Media | Pendiente |
| 5 | Validar self-storage con fulfillment | Media | Pendiente |
| 6 | Crear cuentas Instagram/TikTok | Media | Pendiente |
| 7 | Configurar Shopify + Klaviyo | Baja | Pendiente |

---

## Coherencia entre Documentos

Todos los documentos están alineados con los siguientes datos base:

| Variable | Valor unificado |
|---|---|
| Precio Refill 60 | $24.99 CAD |
| Precio Refill 30 | $14.99 CAD |
