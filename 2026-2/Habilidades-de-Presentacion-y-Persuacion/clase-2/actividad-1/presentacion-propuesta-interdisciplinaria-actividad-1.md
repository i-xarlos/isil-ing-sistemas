...
```mermaid
graph TD
    A[Formar Equipos] --> B[Seleccionar Tema Interdisciplinario]
    B --> C[Diseñar Presentación]
    C --> D[Adaptar al Estilo C]
    D --> E[Practicar Presentación]
    E --> F[Presentar ante Grupo 7]
    F --> G[Recibir Retroalimentación]
```
