# Arquitectura Empresarial — Clase 02 (Resumen)
...
- Diagramas de relaciones entre procesos, aplicaciones y datos.
- Documento breve de estado actual (**AS-IS**) y estado objetivo (**TO-BE**).
